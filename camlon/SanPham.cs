    ...
    public partial class SanPham : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
                ...
                else
                {
                    ...
                    cmd.Parameters.AddWithValue("@ck1", float.Parse(txtCK1.Text));
                    cmd.Parameters.AddWithValue("@ck2", float.Parse(txtCK2.Text));
        ...
        private void dataGridView1_MouseClick(object sender, MouseEventArgs e)
        {
            try{
                ...
                var cmd = new SqlCommand(query, con);
                cmd.Parameters.AddWithValue("@mahang", dataGridView1.SelectedRows[0].Cells[0].Value.ToString());
                ...
                while (dr.Read())
                {
                    ...
                    txtCK2.Text = string.Format("{0:n0}",dr["ck2"]);
